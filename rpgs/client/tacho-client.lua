...
addEventHandler("onClientRender", getRootElement(),
	function()
		...
		elseif veh then 
			if ((getElementData(getLocalPlayer(), "job") == 10)) and getElementData(getLocalPlayer(), "dienst") == 1 then
...
addEventHandler("onClientVehicleEnter", getRootElement(),
    function(thePlayer, seat)
        if thePlayer == getLocalPlayer() then
			...
			if seat == 0 then
				showTutorialMessage("tacho_3", "Fahrzeuge haben auf 'Villages Town' einige Zusatzfunktionen, die es auf anderen Servern oder im Singleplayer nicht gibt. Drücke 'num_1' oder 'c' um den Motor zu starten/stoppen.\nDas Licht kannst du mit 'num_8' betätigen.")
...
setTimer ( saveVehicleStuff, 3000, 0 )
