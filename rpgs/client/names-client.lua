		...
		if getElementData(getLocalPlayer(), "isPlayerLoggedIn") == true then
			...
			if getElementData(getLocalPlayer(), "job") == 9 and getElementData(getLocalPlayer(), "dienst") == 1 or getElementData(getLocalPlayer(), "interview") == true then
				if is_u_bound == false then
					bindKey("u", "down", "chatbox", "San News" )
					is_u_bound = true
				end
			else
			...
			if getElementData(getLocalPlayer(), "hideTacho") ~= true  then
				...
				if getElementData(getLocalPlayer(), "viNetworkMuted") then
					dxDrawText("San News lokal deaktiviert", screenWidth-149, 191, screenWidth-12, 196, tocolor(0,0,0,150), 1, default_bold_smaller, "center", "center", false, false, false, false, true)
					dxDrawText("San News lokal deaktiviert", screenWidth-150, 190, screenWidth-13, 195, tocolor(255,100,0,255), 1, default_bold_smaller, "center", "center", false, false, false, false, true)		
				end				
