...
BankKontoEinloggenWindow[1] = guiCreateWindow(screenWidth/2-311/2,screenHeight/2-225/2,311,225,"Bank von Villages Town",false)
...
BankKontoUebersichtWindow[1] = guiCreateWindow(screenWidth/2-311/2,screenHeight/2-225/2,311,225,"Bank von Villages Town",false)
BankKontoUebersichtLabel[1] = guiCreateLabel(10,27,290,20,"Kontoname: Unbekannt",false,BankKontoUebersichtWindow[1])
...
BankKontoUeberweisenWindow[1] = guiCreateWindow(screenWidth/2-500/2,screenHeight/2-300/2,500,300,"Bank von Villages Town",false)
...
BankKontoDispoWindow[1] = guiCreateWindow(screenWidth/2-243/2,screenHeight/2-225/2,243,225,"Bank von Villages Town",false)
...
function spendeReporter()
	if tonumber(guiGetText(BankKontoUebersichtEdit[1])) then
		...
		triggerServerEvent("bank2:transfer", getLocalPlayer(), bankGUI.accountname , "San News", math.round(tonumber(guiGetText(BankKontoUebersichtEdit[1]))), "Spende")
	end
end
