...
function renderVitaCredtis()
	...
	elseif isAtCreditsPoint == 2 then
		dxDrawText( "Villages Town Online präsentiert...", screenWidth/2 + screenWidth/8 + 1, screenHeight-screenHeight/4 + 1, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha ), 1, "bankgothic" )
		dxDrawText( "Villages Town Online präsentiert...", screenWidth/2 + screenWidth/8, screenHeight-screenHeight/4, screenWidth, screenHeight, tocolor ( 255, 255, 255, imageAlpha ), 1, "bankgothic" )
	...
	elseif isAtCreditsPoint == 4 then
		dxDrawText( "...ein Gemeinschaftsprojekt", screenWidth/2 + screenWidth/10 + 1, screenHeight-screenHeight/4 + 1, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha ), 1, "bankgothic" )
		dxDrawText( "...ein Gemeinschaftsprojekt", screenWidth/2 + screenWidth/10, screenHeight-screenHeight/4, screenWidth, screenHeight, tocolor ( 255, 255, 255, imageAlpha ), 1, "bankgothic" )
		if imageAlpha ~= 255 then
			imageAlpha = imageAlpha +5
		end
		if vitaCreditsTimer == false then
	...
	elseif isAtCreditsPoint == 71 then	
		...
		elseif isAtCreditsPoint == 9 then
			...
			dxDrawText( "Steve '...'\nMarcel  'Marcel-Paul'\nMatze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 1 + 25, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
			dxDrawText( "Steve '...'\nMarcel  'Marcel-Paul'\nMatze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'", screenWidth/2 - screenWidth/2.5, screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )			
	...
	elseif isAtCreditsPoint == 13 then
		...
		dxDrawText( "Matze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'\nSebastian 'Sebihunter' M.", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 25 + 1, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
		dxDrawText( "Matze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'\nSebastian 'Sebihunter' M.", screenWidth/2 - screenWidth/2.5, screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )
	...
	elseif isAtCreditsPoint == 20 then
		...
		dxDrawText( "Steve '...'\nMarcel  'Marcel-Paul'\nMatze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'", screenWidth/2 + screenWidth/6 + 1, screenHeight-screenHeight/3 + 1 + 25, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
		dxDrawText( "Steve '...'\nMarcel  'Marcel-Paul'\nMatze 'Matze.GamingTv'\nMaxi 'Talorin.Goldberry'", screenWidth/2 + screenWidth/6, screenHeight-screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )		
	elseif isAtCreditsPoint == 22 then
		...
		elseif isAtCreditsPoint == 23 then
			...
			dxDrawText( "Matze 'Matze.GamingTv'\nSebastian 'Sebihunter' M.", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 1 + 25, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
			dxDrawText( "Matze 'Matze.GamingTv'\nSebastian 'Sebihunter' M.", screenWidth/2 - screenWidth/2.5, screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )	
	...
	elseif isAtCreditsPoint == 27 then
		...
		if imageAlpha ~= 255 then
			...
			dxDrawText( "x86\nNeon\nTjong\nEinstein\nWerni\nryden\nmabako\nFrankZZ\nNitaco\nSense\Sebihunter", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 1 + 25, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
			dxDrawText( "x86\nNeon\nTjong\nEinstein\nWerni\nryden\nmabako\nFrankZZ\nNitaco\nSense\Sebihunter", screenWidth/2 - screenWidth/2.5, screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )		
	elseif isAtCreditsPoint == 28 then
		...
		if imageAlpha ~= 0 then
			...
			dxDrawText( "Danke an", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 1, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha ), 1, "bankgothic" )
			dxDrawText( "Danke an", screenWidth/2 - screenWidth/2.5, screenHeight/3, screenWidth, screenHeight, tocolor ( 255, 255, 255, imageAlpha ), 1, "bankgothic" )
			dxDrawText( "x86\nNeon\nTjong\nEinstein\nWerni\nryden\nmabako\nFrankZZ\nNitaco\nSense\nSebihunter", screenWidth/2 - screenWidth/2.5 + 1, screenHeight/3 + 1 + 25, screenWidth, screenHeight, tocolor ( 0, 0, 0, imageAlpha2 ), 0.8, "bankgothic" )
			dxDrawText( "x86\nNeon\nTjong\nEinstein\nWerni\nryden\nmabako\nFrankZZ\nNitaco\nSense\nSebihunter", screenWidth/2 - screenWidth/2.5, screenHeight/3 + 25, screenWidth, screenHeight, tocolor ( 200, 200, 200, imageAlpha2 ), 0.8, "bankgothic" )				
