...
function setFirmenMarker()
	...
	elseif itemtext == "Fischer" then
		x = -1686.5
		y = 1451.2
	elseif itemtext == "Gärtner" then -- Neue Makierung
		x = 930.7
		y = -1111.4
	elseif itemtext == "Pizzalieferant" then -- Neue Makierung
		x = 2102.9
		y = -1769.8
	elseif itemtext == "Taxifahrer" then -- Neue Makierung
		x = 1752.7
		y = -1894.1
...
function setVerdienst()
	if getElementData(getLocalPlayer(), "rank") == 2 then
		...
		if selectedRow ~= -1 then
			...
			if gehalt > 10000 or gehalt < 0 then
