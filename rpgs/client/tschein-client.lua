...
local marker = createMarker ( -2026.8, -114.7, 1035.2, "cylinder", 1, 0, 0, 255, 170 )
...
function enable (ele, dim)
	...
	if isOn then 
		showTutorialMessage("tschein_2", "Da zur Zeit ein Fahrlehrer im Dienst ist kannst du dein T-Schein leider nicht machen.")
		return addNotification(1, 255, 0, 0, "Du kannst keinen temporären Führerschein machen,\nwenn ein Fahrlehrer im Dienst ist.")
	end
	showTutorialMessage("tschein_1", "Mit dem T-Schein kannst du zwei Wochen lang Autos fahren. Für andere Fahrzeugtypen oder nach dieser Probezeit benötigst du jedoch einen echten Führerschein von der Fahrschule.")
