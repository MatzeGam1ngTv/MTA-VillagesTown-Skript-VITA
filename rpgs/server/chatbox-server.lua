...
function onPlayerChat( message, messageType )
	...
	if getElementData(source, "isPlayerLoggedIn") == true and getElementData(source, "isWaitingForDeath") == false then
		...
		if messageType == 0 then
			...
			print("Villages Town Online: "..getPlayerName(source)..": "..message)
		...
		elseif messageType == 1 then
			...
			print("/me Villages Town Online: "..getPlayerName(source)..": "..message)			
			for index, nearbyPlayer in ipairs( nearbyPlayers ) do
				if getElementData(nearbyPlayer, "isPlayerLoggedIn") == true then
...
addCommandHandler( "mega",
	function( thePlayer, commandName, ... )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true then
			...
			local nearbyString = ""
			if #message > 0 then
				print("Villages Town Online: [MEGAPHONE] "..getPlayerName(thePlayer)..": "..message)
	...
	function( thePlayer, commandName, ... )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true and tonumber(getElementData(thePlayer, "getPlayerSpecialRights")) ~= 0 then
			...
			if #message > 0 then
				...
				print("Villages Town Online: [AC] "..getPlayerName(thePlayer)..": "..message)
			else
...
addCommandHandler( { "VTAktiviereOOC"},
	function( thePlayer, commandName )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true then
...
addCommandHandler( { "aca" },
	function( thePlayer, commandName, ... )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true then
			...
			local message = table.concat( { ... }, " " )
			if #message > 0 then
				print("Villages Town Online: [ADMIN] "..getPlayerName(thePlayer)..": "..message)
	...
	function( thePlayer, commandName, ... )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true then
			...
			if #message > 0 then
				...
				local nearbyPlayers = getElementsWithinColShape( chatSphere, "player" )
				destroyElement( chatSphere )
				print("Villages Town Online: [L-OOC] "..getPlayerName(thePlayer)..": "..message)
				for index, nearbyPlayer in ipairs( nearbyPlayers ) do
...
addCommandHandler( { "O.O.C", "o", "ooc"},
	function( thePlayer, commandName, ... )
		if getElementData(thePlayer, "isPlayerLoggedIn") == true then
			...
			local message = table.concat( { ... }, " " )
			if #message > 0 then
				print("Villages Town Online: [OOC] "..getPlayerName(thePlayer)..": "..message)
				for i,v in ipairs(getElementsByType("player")) do
