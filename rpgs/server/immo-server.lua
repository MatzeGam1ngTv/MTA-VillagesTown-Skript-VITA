...
function showIntList(player, command)
	if getElementData(player, "job") == 6 or getElementData(player, "getPlayerSpecialRights") == 1 or getElementData(player, "getPlayerSpecialRights") == 2 then
		outputChatBox( "***Interiors***", player, 0, 255, 255 )
		outputChatBox( "Klein: 4, 7, 12, 13", player, 255, 255, 255 )
		outputChatBox( "Mittel: 1, 2, 6, 8, 10", player, 255, 255, 255 )
		outputChatBox( "Groß: 3, 5, 9, 11", player, 255, 255, 255 )
	    outputChatBox( "***Interiors***", player, 0, 255, 255 )
	end	
end
