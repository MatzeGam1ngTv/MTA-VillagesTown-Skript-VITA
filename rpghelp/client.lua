...
function updateCamera ()
	...
	if rulesAlpha ~= 0 or showRules == true then
		...
		dxDrawShadowedText("Villages Town - Hilfemenü",screenWidth/2-315,screenHeight/2-235, screenWidth, screenHeight, tocolor(240,240,180,255*rulesAlpha),tocolor(0,0,0,255*rulesAlpha), 1, "default-bold" , "left", "top", false, false, false, true)
	end
end
...
daStandartText = [[Herzlich Willkommen in der Hilfe von Villages Town!
...
Forum: www.villages-town.de
Teamspeak³: 79.133.59.107]]

----------------------------------------------------------------------
----------------------------------------------------------------------BEFEHLE
----------------------------------------------------------------------
daRules = {}
daRules[2] = [[Bei Villages Town gibt es im Gegensatz zu anderen Servern wenige Pickups
...
Fahrschule:
 /fschild
 /fschein [Spielername] [FscheinID (Auto-Führerschein=1, Motorradschein=2, Gefahrgutschein=3, Flugschein=4)] [Preis]
 /pif [Spielername] [Punkte]
 ]]
...
daRules[12] = [[Villages Town basiert auf einem Selfmade-Script und ist daher anders, als der Großteil der übrigen Server in MTA:SA.
...
-> Komme wenn möglich auf unseren Teamspeak (IP: 79.133.59.107)
-> Habe Spaß auf Villages Town
]]
...
Um bei einem Unternehmen zu arbeiten musst du dich im Forum (www.villages-town.eu) bei dem jeweiligen Chef in seinem Bereich bewerben.
...
Tod:
Solltest du bei einer Reise durch Villages Town gestorben sein wirst du kostenfrei vom Sanitäterwieder wiederbelebt oder im Krankenhaus in Las Venturas geheilt und respawnt.
...
daRules[18] =   [[Roleplay:
Roleplay ist eine gewisse Spielart, wie der Name es schon sagt,  ein Rollenpiel. Man spielt eine bestimmte Rolle, zum Beispiel Polizist oder Mechaniker. Auf Villages Town ist es ungern gesehen, wenn deine Rolle nicht in unser realistisches Spielszenario passt (z.B. Superschurke).
...
..::Villages Town Rollenspiel Regelwerk::..
29.11.2014
...
(1) Jedes Mitglied hat das Recht, bei Umfragen über verschiedene Villages Town bezogene Themen seine Stimme abzugeben.
...
(2) Das Werben für villages-town.eu im Bereich anderer MTA-Server ist ebenfalls verboten. Verstoß wird mit einem permanenten Bann bestraft.
