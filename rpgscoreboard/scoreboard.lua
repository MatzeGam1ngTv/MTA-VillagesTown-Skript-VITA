...
function renderScoreboard()
	...
	if scoreboardAlpha ~= 0 then
		...
		if realScoreboardAlpha  then
			...
			dxDrawText ( "Villages Town Roleplay - Lebt wie ihr wollt"	, screenWidth/2-640/2+100, screenHeight/2-(600-(32-sc_allPlayers)*12)/2+60+startAnim, screenWidth, screenHeight, tocolor ( 0, 145, 255, realScoreboardAlpha ), 0.8, scoreboardFont )
			...
			dxDrawText ( "Admin | Spielername", screenWidth/2-640/2+3, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "Unternehmen", screenWidth/2-640/2+210, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "Gang", screenWidth/2-640/2+335, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "Level", screenWidth/2-640/2+420, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "Status", screenWidth/2-640/2+475, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "FPS", screenWidth/2-640/2+540, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			dxDrawText ( "Ping", screenWidth/2-640/2+600, scoreboardY+53+startAnim, screenWidth, screenHeight, tocolor(0, 255, 25, realScoreboardAlpha), 1, "sans" )
			...
			for id, player in ipairs(thePlayers) do
				...
				if getElementData(player, "getPlayerSpecialRights") == 5 then
					dxDrawText ( "#FF0000Projektleitung #ffffff| #ffffff"..getPlayerName(player), screenWidth/2-640/2+3, scoreboardY+72+12*sc_allPlayers+startAnim, screenWidth, screenHeight, tocolor(255, 255, 255, realScoreboardAlpha), 0.9, "sans", "left", "top", false, false, false,true )				
				elseif getElementData(player, "getPlayerSpecialRights") == 4 then
					dxDrawText ( "#FF8D00Entwickler #ffffff| #ffffff"..getPlayerName(player), screenWidth/2-640/2+3, scoreboardY+72+12*sc_allPlayers+startAnim, screenWidth, screenHeight, tocolor(255, 255, 255, realScoreboardAlpha), 0.9, "sans", "left", "top", false, false, false,true )
				elseif getElementData(player, "getPlayerSpecialRights") == 3 then
					dxDrawText ( "#005EFFAdministrator #ffffff| #ffffff"..getPlayerName(player), screenWidth/2-640/2+3, scoreboardY+72+12*sc_allPlayers+startAnim, screenWidth, screenHeight, tocolor(255, 255, 255, realScoreboardAlpha), 0.9, "sans", "left", "top", false, false, false,true )
				elseif getElementData(player, "getPlayerSpecialRights") == 2 then
					dxDrawText ( "#00FF40Moderator #ffffff| #ffffff"..getPlayerName(player), screenWidth/2-640/2+3, scoreboardY+72+12*sc_allPlayers+startAnim, screenWidth, screenHeight, tocolor(255, 255, 255, realScoreboardAlpha), 0.9, "sans", "left", "top", false, false, false,true )
				elseif getElementData(player, "getPlayerSpecialRights") == 1 then
					dxDrawText ( "#FFC900Supporter #ffffff| #ffffff"..getPlayerName(player), screenWidth/2-640/2+3, scoreboardY+72+12*sc_allPlayers+startAnim, screenWidth, screenHeight, tocolor(255, 255, 255, realScoreboardAlpha), 0.9, "sans", "left", "top", false, false, false,true )	
				else
				...
				if getElementData(player, "playerRegisterStatus") == "2" or getElementData(player, "playerRegisterStatus") == "1" then -- Check if logged in
					...
					elseif job == 5 then
						jobstring = "#521010AutoScout45"
					elseif job == 6 then
						jobstring = "#0000FFStaatsverwaltung"
					elseif job == 7 then
						jobstring = "#fb6666Krankenhaus"
					elseif job == 8 then
						jobstring = "#fb6666Feuerwehr"
					elseif job == 9 then
						jobstring = "#E2FB03San News"
					elseif job == 10 then						
					...
					if gang == 1 then
						gangstring = "#FF0000Grove"
					elseif gang == 2 then
						gangstring = "#00FF00Ballas"
					elseif gang == 3 then
						gangstring = "#FFFF00Los Vagos"
					end
			...
			dxDrawText ( "© Villages Town", screenWidth/2-640/2, scoreboardY+72+12*sc_allPlayers+5+startAnim, screenWidth/2+640/2, screenHeight, tocolor ( 255, 255, 255, realScoreboardAlpha ), 0.9, "sans-bold", "center", "top" )
